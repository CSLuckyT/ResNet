...
class Block(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        x = x + identity  # Replace in-place operation with out-of-place operation
        return self.relu(x)
...
def resnet50(pretrained=False, img_channels=3, num_classes=1000):
    if pretrained:
...
def resnet101(pretrained=False, img_channels=3, num_classes=1000):
    if pretrained:
...
def resnet152(pretrained=False, img_channels=3, num_classes=1000):
    if pretrained:
